...
public class ConectarBD {
  ...
  private String caminho = "jdbc:sqlserver://localhost:1433;databaseName=DB_FACIL";//se não for acessar localmente mude localhost pelo nome do servidor  
  private String usuario = "MarcosVinicius";//esse usuário é um sysadmin ele tem todos os poderes, é bom que se crie um login e usuário a parte  
  private String senha = "sql";
